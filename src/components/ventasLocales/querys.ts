...
export const QUERY_GET_PRODUCTOS_VENTA_LOCAL = `
  ...
  ORDER BY P.COMBO_ID NULLS LAST, P.ARTICULO_ID
`;
...
// Queries para combos
export const QUERY_INSERT_COMBO_VENTA_LOCAL = `
  INSERT INTO MSP_LOCAL_SALE_COMBO (
    COMBO_ID,
    LOCAL_SALE_ID,
    NOMBRE_COMBO,
    PRECIO_LISTA,
...
export const QUERY_GET_COMBOS_VENTA_LOCAL = `
  SELECT
    C.COMBO_ID,
    C.LOCAL_SALE_ID,
    C.NOMBRE_COMBO,
    ...
    C.PRECIO_CONTADO
  FROM MSP_LOCAL_SALE_COMBO C
  WHERE C.LOCAL_SALE_ID = ?
  ORDER BY C.NOMBRE_COMBO
`;

export const QUERY_DELETE_COMBOS_VENTA_LOCAL = `
  DELETE FROM MSP_LOCAL_SALE_COMBO
  WHERE LOCAL_SALE_ID = ?
`;

export const QUERY_DELETE_COMBO_POR_ID = `
  DELETE FROM MSP_LOCAL_SALE_COMBO
  WHERE COMBO_ID = ?
`;
...
// Queries para vendedores de venta local
export const QUERY_INSERT_VENDEDOR_VENTA_LOCAL = `
  INSERT INTO MSP_LOCAL_SALE_VENDEDOR (
    LOCAL_SALE_ID,
    VENDEDOR_EMAIL,
    NOMBRE_VENDEDOR
  ) VALUES (?, ?, ?)
...
export const QUERY_GET_VENDEDORES_VENTA_LOCAL = `
  SELECT
    VE.LOCAL_SALE_ID,
    VE.VENDEDOR_EMAIL,
    VE.NOMBRE_VENDEDOR
  FROM MSP_LOCAL_SALE_VENDEDOR VE
  WHERE VE.LOCAL_SALE_ID = ?
  ORDER BY VE.NOMBRE_VENDEDOR
`;

export const QUERY_DELETE_VENDEDORES_VENTA_LOCAL = `
  DELETE FROM MSP_LOCAL_SALE_VENDEDOR
  WHERE LOCAL_SALE_ID = ?
`;

export const QUERY_GET_VENDEDORES_UNICOS = `
  SELECT DISTINCT
    VE.VENDEDOR_EMAIL,
    VE.NOMBRE_VENDEDOR
  FROM MSP_LOCAL_SALE_VENDEDOR VE
